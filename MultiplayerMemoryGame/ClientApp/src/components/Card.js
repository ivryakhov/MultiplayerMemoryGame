...
export const Card = (props) => {
    ...
    const matchedStyle = props.matched ? styles.matched : {};   
    const backColor = props.matched ? 'has-background-warning grey-dark' : 'has-background-success has-text-light';
    return (
        <div style={{ ...styles.card, ...openedStyle, ...disabledStyle, ...matchedStyle }} onClick={props.click} disabled={props.disabled}>
